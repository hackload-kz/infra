...
async function createTestData() {
  ...
  const mockUsers = [
    { email: 'alex.petrov@example.com', name: 'Александр Петров', company: 'Яндекс', city: 'Москва', telegram: '@alex_petrov', experienceLevel: 'Продвинутый', technologies: ['JavaScript', 'React', 'Node.js', 'PostgreSQL'], cloudServices: ['AWS EC2', 'S3', 'Lambda'] },
